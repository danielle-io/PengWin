...
export default class HomePage extends Component {
    ...
    render() { 
        ...
        return (
            console.log("screen ehig", screenHeight),
            ...
            <Image
                source={Mamanbaby}
                style={{ alignSelf:'center', justifyContent: 'center', marginTop: '20%'}}
                />
            ...
            {/* <View style={{alignItems:"flex-start"}}> */}
                ...
                onPress={() => {this.navigate("SignUp",{prevScreenTitle: 'Back'})}}
                >
                <View>
                ...
                >
                <View>
                <Text style={[styles.buttonPrimaryText, {color: '#5A5A5A'}]}>Child</Text>
                </View>
