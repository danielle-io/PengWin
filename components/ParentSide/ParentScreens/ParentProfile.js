    ...
    async changeUserComponent(tag, value, id) {
        ...
        try {
            let response = await fetch(
                'http://' + Environment + '/updateUser/' + id,
                {
                    method: "POST",
                    headers: {
        ...
        return this.state.childResults.map(itemValue => {
            ...
            return (
                < TextField
                    ...
                    onEndEditing={e => { this.changeUserComponent('first_name', this.state.childFirstName, itemValue.user_id) }}
            ...
            return (
                ...
                <View style={styles.parentProfileFormContainer}>
                    ...
                    < TextField
                        ...
                        onFocus={e => console.log('Focus', !!e)}
                        onBlur={e => console.log('Blur', !!e)}
                        onEndEditing={e => { this.changeUserComponent('first_name', this.state.parentFirstName, this.state.userId) }}
                        onSubmitEditing={e => console.log('SubmitEditing', !!e)}
                    ...
                    < TextField
                        ...
                        onFocus={e => console.log('Focus', !!e)}
                        onBlur={e => console.log('Blur', !!e)}
                        onEndEditing={e => { this.changeUserComponent('last_name', this.state.parentLastName, this.state.userId) }}
                        onSubmitEditing={e => console.log('SubmitEditing', !!e)}
                    ...
                    < TextField
                        ...
                        onFocus={e => console.log('Focus', !!e)}
                        onBlur={e => console.log('Blur', !!e)}
                        onEndEditing={e => { this.changeUserComponent('email', this.state.email, this.state.userId) }}
                        onSubmitEditing={e => console.log('SubmitEditing', !!e)}
